...
public class Result
{
    ...
    {
        Conclusion = true;
        //this.ResultType = AgoraEasyMac.Application.ResultType.Ok;
    }
    ...
    public Result(IEnumerable<string> errorMessages, Exception exception = null)
    {
        Conclusion = false;
        ErrorDescription = new ErrorDescription();
    ...
    public void Set(IEnumerable<string> errorMessages, Exception exception = null)
    {
        Conclusion = false;
        ErrorDescription = new ErrorDescription();
        ErrorDescription.ErrorMessage = string.Join("\n", errorMessages);
...
public class Result<T> : Result
{
    ...
    public Result(string errorMessage, Exception exception = null) : base(errorMessage, exception) { }
...
public class ErrorDescription
{
    ...
    //{
    //    return new AppException(ErrorMessage, Exception);
    //}
}
...
//    public AppException(string errorMessage, Exception exception) : base(errorMessage, exception)
//    {
//        //ErrorType = errorType;
//    }
...
//    {
//        return new Result(Message, InnerException);
//    }
